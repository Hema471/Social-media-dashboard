const SocialCardBox = ({
  ...
  return (
    <div
      className={`container card-hover max-w-full max-h-full w-[320px] h-[265px] rounded-md border-t-4 bg-[#F8F9FE]`}
    ...
    >
      <div className="flex-col element-center gap-5 p-10">
        ...
        <p className="uppercase text-sm tracking-[5px] text-[#63687E]">followers</p>
